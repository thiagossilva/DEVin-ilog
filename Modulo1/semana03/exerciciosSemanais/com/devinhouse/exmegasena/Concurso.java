...
public class Concurso implements Comparable<Concurso>{
    ...
    public String formatarNumerosSorteadosOrdenados() {
        List<Integer> sorteadosOrdenados = ConversorArraysToList.converterOrdenado(sorteados);
        return "Concurso{" +
                "numero=" + numero +
                ", data=" + data +
                ", sorteados=" + sorteadosOrdenados +
                '}';
    }
